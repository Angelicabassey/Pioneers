        ...
        <main className="bg-herobg">
            <div className="flex items-center justify-around px-12 py-16 flex-wrap">
                <div className="flex flex-col gap-6 w-2/4">
                    <h3 className="font-medium text-main text-5xl">Discover Solana: <br/>Learn, <p className="text-primarytext">Earn</p> and Thrive <br/> in the Web3 Economy</h3>
                    ...
                    <div className=" bg-main px-6 py-2 rounded-md w-4/12">
                        <link className='flex items-center text-center' href="./login">
